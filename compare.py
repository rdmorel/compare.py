...
class Compare(object):
	...
	def runall(self):
		...
		for map in self.maps:
			...
			for scheme in self.schemas:
				...
				#replace "SchemaDemo" with scheme in file
				...
				filedata = filedata.replace('SchemaDemo', scheme)
 ...
 #run scheme on map and pipe output to map.dscscheme.txt



	def getratings(self):
		#makes list of Rating objects with (name, time)
		mapnum = 0
		for map in self.maps:
			for scheme in self.schemas:
